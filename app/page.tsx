      ...
      <footer className="relative z-10 w-full py-8 bg-[#0f1520] text-white mt-20 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 text-sm">
            <a href="mailto:lutfiamwandoli@gmail.com" className="hover:text-blue-400 transition">
              📧 Email: <span className="font-medium">lutfiamwandoli@gmail.com</span>
            </a>
            <a href="https://wa.me/6282288471175" target="_blank" className="hover:text-green-400 transition">
